    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-12 flex-1">
        ...
        <CustomFormField 
          ...
          label="I consent to the treatment of my medical information by this physician."
        />
        ...
        <CustomFormField 
          ...
          label="I consent to the disclosure of my medical information to my physician."
        />
        ...
        <CustomFormField 
          ...
          control={form.control}
          name="privacyConsent"
          label="I consent to the privacy of my medical information."
        />
